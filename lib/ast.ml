...
and expr =
  ...
  | EEffectDef of string * string list                   (* effect Name { op1; op2 } *)
  | EPerform of string * expr                            (* perform op arg *)
  | EHandle of expr * (string * string * string * expr) list  (* handle expr with { op arg k -> body } *)
